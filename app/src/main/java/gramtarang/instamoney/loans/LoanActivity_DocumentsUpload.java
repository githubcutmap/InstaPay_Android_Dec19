...
public class LoanActivity_DocumentsUpload extends AppCompatActivity {
    private Button businessPhoto, idProof, propertyProof;
    private Button upload, cancel;
    private ImageView photoSuccess, idSuccess, propertySuccess;
    private int flag = 0;
    private int imageflag = 0;
    private static final int PERMISSION_REQUEST_CODE = 1;
    private static final int REQUEST_GALLERY = 200;
    private Spinner sp_idDetails;
    private String file_path = null, upload_selection, appId, aadhaar, username, password;
    private TextView tv_uniqueId, tv_loanamount;
    SharedPreferences preferences, preferences2;
    private String extflag, extension, beneficiaryUniqueId, beneficiaryUniqueId2, loanAmount, idDetails;
